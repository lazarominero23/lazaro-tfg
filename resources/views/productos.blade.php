...
<head>
    ...
    <title>No Escape From Game | Los Mejores Productos Gaming</title>
...
<div class="d-flex align-items-center gap-3">
    ...
    <div class="container mt-4">
        ...
        <form method="GET" action="{{ route('metodoFiltrarCategoria') }}" class="mb-3">
            <div class="row">
                <div class="col-md-4">
                    <select name="categoria" class="form-select">
                        <option value="" disabled selected>Selecciona una categoría</option>
                        <option value="Videojuegos" {{ request('categoria') == 'Videojuegos' ? 'selected' : '' }}>Videojuegos</option>
                        <option value="Consolas" {{ request('categoria') == 'Consolas' ? 'selected' : '' }}>Consolas</option>
                        <option value="Merchandising" {{ request('categoria') == 'Merchandising' ? 'selected' : '' }}>Merchandising</option>
                    </select>
                </div>
                <div class="col-md-3">
        ...
        @if(request('categoria') || request('nombre'))
            <div class="mt-2">
